...
def compilation_summary(compilation: HadamardTestCompilation) -> dict[str, object]:
    ...
    return {
        ...
        "prefix_height_strategy": compilation.prefix_height_policy_label,
        "prefix_height_loads": level_2_metadata.get("prefix_height_loads"),
        "prefix_height_moves": level_2_metadata.get("prefix_height_moves"),
        "prefix_height_unloads": level_2_metadata.get("prefix_height_unloads"),
        "prefix_height_path_steps": level_2_metadata.get(
